...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Documents/insper/elementos/Z01.1-Insonia/Projetos/G-Computador/vunit_out/test_output/lib.tb_memoryio.all_693188ce223cc7c1fc8926d3961549e052c55f8a/vunit_results" "r"]
...
proc vunit_compile {} {
    ...
    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', './testeHW.py', '--compile', 'lib.tb_memoryio.all'], cwd='/home/borg/Documents/insper/elementos/Z01.1-Insonia/Projetos/G-Computador', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
